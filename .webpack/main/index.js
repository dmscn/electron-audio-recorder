...
let preload = '/home/dmscn/dev/electrion-audio-recorder/.webpack/renderer/main_window/preload.js';
...
electron_1.app.on('ready', () => {
    ...
    electron_1.ipcMain.handle('save-audio', (_event, buffer) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Get the temporary directory
            const tempDir = electron_1.app.getPath('temp');
            const inputFilePath = path_1.default.join(tempDir, `audio_${Date.now()}.webm`);
            const outputFilePath = path_1.default.join(tempDir, `audio_${Date.now()}.wav`);
            // Write the WebM buffer to a file
            fs_1.default.writeFileSync(inputFilePath, Buffer.from(buffer));
